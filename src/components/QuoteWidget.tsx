...
export default function QuoteWidget() {
  ...
  const tipAmount = selectedQuote
    ? usingCustomTip
      ...
      : tipPct > 0
        ? Math.round(selectedQuote.price * tipPct) / 100
        : 0
    : 0;
  ...
  return (
    <div className="bg-zinc-900/80 backdrop-blur-xl border border-yellow-500/30 rounded-2xl p-8 shadow-[0_0_0_1px_rgba(234,179,8,0.08)]">
